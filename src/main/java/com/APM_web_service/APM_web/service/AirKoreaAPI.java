...
public class AirKoreaAPI {
    public static String fetchDataAndParse() throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("stationName", "UTF-8") + "=" + URLEncoder.encode("도고면", "UTF-8")); // 측정소명
